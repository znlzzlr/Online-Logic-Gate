...
<script>
    ...
    function spawnPreset(name) {
        ...
        if (name === 'D_FLIP_FLOP') {
            ...
            connections.push({fromId: inS.id, toId: nor1.id, toIdx: 0}, {fromId: inR.id, toId: nor2.id, toIdx: 1}, {fromId: nor1.id, toId: not1.id, toIdx: 0}, {fromId: nor2.id, toId: not2.id, toIdx: 0}, {fromId: not1.id, toId: nor2.id, toIdx: 0}, {fromId: not2.id, toId: nor1.id, toIdx: 1}, {fromId: not1.id, toId: outQ.id, toIdx: 0});
        }
    }
